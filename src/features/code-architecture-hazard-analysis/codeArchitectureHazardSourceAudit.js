...
function makeMissingExtractTrajTokensRow(records = [], rows = []) {
  ...
  return {
    ...
    toFunction: "trajectory token consumers",
    fromFile: filePath,
    toFile: filePath,
    ...
    syntheticHazardSummaryRow: {
      ...
      "Function (To)": "trajectory token consumers",
      ...
      "Causal Factors": "Indexed source evidence shows invalid trajectory token values are detected and clamped.",
