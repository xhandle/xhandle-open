...
const EVIDENCE_FIELDS = [
  ...
  ["Causal Effect", [/^Causal Effect$/i]],
  ["Resulting System State", [/^Resulting System State$/i]],
  ["Intermediate Safety Function", [/^Intermediate Safety Function$/i]],
  ["Intermediate Safety Effect", [/^Intermediate Safety Effect$/i]],
  ["Protection Assessment", [/^Protection Assessment$/i]],
  ["Protection Status", [/^Protection Status$/i]],
  ["Classification Evidence", [/^Classification Evidence$/i]],
  ["Classification Confidence", [/^Classification Confidence$/i]],
