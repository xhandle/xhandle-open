 ...
 *
 * Mirrors generateAgenticReport.js, including retries.
 * NOTE: Calling OpenAI from the browser exposes your token; prefer server-side in production.
 */
...
function normalizeHazardRow(row, rowIdx) {
  ...
  const sysReq = pick(["System Requirement", "Requirement", "Safety Requirement", "Safety Requirements/Constraints", "Consolidated Requirement"]);
